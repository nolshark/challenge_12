...
const getAllEmployees = () => 
    promiseQuery('SELECT employee.id, employee.first_name, employee.last_name, role.title AS role, employee.manager_id FROM employee LEFT JOIN role ON employee.role_id = role.id;');
